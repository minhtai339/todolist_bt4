...
const App = () => {
  ...
  const [selectedValue, setSelectedValue] = useState('Trình độ'); // State cho Picker
  const addTask = () => {
  ...
  <View style={styles.container}>
    ...
    >
      <Picker.Item label="Trình độ phổ thông " value="trình độ phổ thông " />
      <Picker.Item label="Trình độ chuyên nghiệp " value="Trình độ chuyên nghiệp" />
